        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
            		<div class="col-md-10">
                		<h4 class="card-title">Franchise Category Create</h4>
            		</div>
                ...
                <div class="card-body mt-2">
                  {!! Form::open(array('route' => 'franchise-category.store','method'=>'POST','files'=>	'true','class'=>'form')) !!}
