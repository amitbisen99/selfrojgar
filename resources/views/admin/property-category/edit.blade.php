	    ...
	    <div class="col-12">
	        <div class="card">
	            <div class="card-header">
	                <div class="col-md-10">
                		<h4 class="card-title">Property Category Edit</h4>
            		</div>
	            ...
	            <div class="card-body">
	              	{!! Form::model($propertyCategory, ['method' => 'PUT','route' => ["property-category.update", $propertyCategory->id],'files'=>true, 'class'=>'form']) !!} 
